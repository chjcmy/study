---
tags: [Kotlin, 객체지향, 타입캐스팅, SmartCast, as, as?]
aliases: [Kotlin Type Casting, 타입 캐스팅, 스마트 캐스트]
---

# 코틀린 타입 캐스팅 (Type Casting)
...
> [[5-4. 다형성.md|⬅️ 이전: 다형성]] | [[5-6. 봉인된 클래스.md|➡️ 다음: 봉인된 클래스]]